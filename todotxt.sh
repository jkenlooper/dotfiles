...
if [ -d todo.txt_cli-2.12.0 ]; then
  echo 'todo.txt_cli already installed?';
else
  curl https://github.com/todotxt/todo.txt-cli/releases/download/v2.12.0/todo.txt_cli-2.12.0.tar.gz -O -L


  tar -xf todo.txt_cli-2.12.0.tar.gz
